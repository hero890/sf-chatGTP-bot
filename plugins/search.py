    ...
    if AI == True: 
        ...
        if user_id:
            try:
                ...
                footer_credit = "<b><a href='https://t.me/+ccx-5xVHyro3ZjNl'>• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •</a>══<a href='https://t.me/what_if_season_2_hindi_dubb'>• ᴄᴏɴᴛᴀᴄᴛ ᴍᴀꜱᴛᴇʀ •</a></b>"
                ...
                print(error)
                await message.reply_text(f"**An error occurred:**\n\n**{error}**\n\n**Forward This Message To @hero_botss**")
    else:
        return
